...
if __name__ == '__main__':
    ...
    kb.btk_service.send_keys([161, 1, 0, 0, 40, 0, 0, 0, 0, 0])
    sleep(.2)
    kb.btk_service.send_keys([161, 1, 0, 0, 0, 0, 0, 0, 0, 0])
    sleep(.2)
    kb.btk_service.send_keys([161, 1, 0, 0, 43, 0, 0, 0, 0, 0])
    sleep(.2)
    kb.btk_service.send_keys([161, 1, 0, 0, 0, 0, 0, 0, 0, 0])
    sleep(.2)
    kb.btk_service.send_keys([161, 2, 0, 0, 40, 0, 0, 0, 0, 0])
    sleep(.2)
    kb.btk_service.send_keys([161, 2, 0, 0, 0, 0, 0, 0, 0, 0])
    sleep(.2)
    kb.btk_service.send_keys([161, 2, 0, 0, 43, 0, 0, 0, 0, 0])
    sleep(.2)
    kb.btk_service.send_keys([161, 2, 0, 0, 0, 0, 0, 0, 0, 0])
